...
def main(pop, gen, cr, fx, datafile):
    # Test
    score = cr * pop / gen
    score -= fx
    freq = 1000
    ...
    _, aptitudes, _ = DE(init_samples, gen, pop, cr, fx, ranges, original, scale, freq)
    score = -aptitudes[-1]
    print(score)
...
if __name__ == '__main__':
    ...
    arg_parse.add_argument('--gen', dest='gen', type=int, required=True, help='Generations')
    ...
    main(args.pop, args.gen, args.cr, args.fx, args.datafile)
